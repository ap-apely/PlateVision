...
from license_plates_text.model.attention import Attention  # , SelfAttention
...
class CRNN(nn.Module):
    ...
    def forward(self, images, targets=None):
        ...
        if self.use_attention:
            attention, _ = self.attention(hiddens, features)
            x = hiddens * attention
    ...
    def nll_loss(self, x, targets, sequence_length: int = 45):
        ...
        scalar = 20 #for increase speed of learning and learn model to know that text is padded
