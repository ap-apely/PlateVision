...
class ClassificationDataset:
    """
    A dataset class for image classification tasks.
    
    Attributes:
        image_paths (list): List of paths to images.
        targets (list): List of corresponding target labels.
        resize (tuple, optional): Resize dimensions. Defaults to None.
        grayscale (bool, optional): Whether to convert images to grayscale. Defaults to False.
    """
    def __init__(self, image_paths, targets, resize=None, grayscale=False):
        ...
        """
        Compose albumentations transformations.
        
        Attributes:
            mean (tuple): Mean values for normalization.
            std (tuple): Standard deviations for normalization.
        """
    ...
    def __getitem__(self, item):
        ...
        Returns:
            dict: Dictionary containing "images" and "targets" tensors.
        """
...
def build_dataloaders(cfg):
    """
    Build data loaders for training and testing sets.
    
    Args:
        cfg: Configuration object containing dataset paths, batch sizes, etc.
    
    Returns:
        tuple: Training loader, testing loader, test original targets, and a list of encoded class labels.
    """
    ...
    targets_encoded = np.array(targets_encoded, dtype="object")
    ...
    train_dataset = ClassificationDataset(
        ...
        resize=(cfg.text_recognition.processing.image_height, cfg.text_recognition.processing.image_width),
        grayscale=cfg.text_recognition.model.gray_scale,
    )

    train_loader = torch.utils.data.DataLoader(
        train_dataset,
        batch_size=cfg.text_recognition.training.batch_size,
        num_workers=cfg.text_recognition.training.num_workers,
        shuffle=True,
    )
