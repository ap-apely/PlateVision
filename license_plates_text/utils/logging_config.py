...
def setup_logging():
    """
    This function sets up logging with a custom format.
    
    The datefmt is set to "%d/%m/%Y %H:%M:%S" and the fmt is set to "[%(levelname)s][%(asctime)s]: %(message)s".
...
def general_table():
    """
    This function returns a table with specific columns.
...
def predictions_table():
    """
    This function returns a table for displaying predictions.
